...
destinationPath = 'C:\\Users\\lab\\Documents\\MATLAB\\Flanker_task_2016-master\\Subjects'

# Computer names for remote computers with source folders
compNames = paste('CC',3:8,sep='')
compIndex = as.character(3:8)

# Source folder path on a given computer
folderPath = '\\Users\\lab\\Documents\\MATLAB\\Flanker_task_2016\\Subjects'
